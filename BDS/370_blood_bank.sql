...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 27, 2023 at 08:05 PM
...
('abul9900', '2023-03-27', 'Medinova Medical'),
('amin71', '2023-07-30', 'Ibn Sina Hospital'),
('amina441', '2023-07-08', 'Combined Military Hospital'),
('anwarul9900', '2023-05-07', 'Ad-Din Medical'),
('arman_m', '2023-04-16', 'Mugda Medical College'),
('asadullah3322', '2023-03-31', 'Combined Military Hospital'),
('ayesha55', '2023-01-03', 'Mugda Medical College'),
('azizul55', '2023-07-06', 'Holy Family Hospital'),
('farhad779', '2023-01-25', 'Popular Medical College and Hospital'),
('farhana123', '2022-09-28', 'Kurmitola General Hospital'),
('farid225', '2023-02-19', 'Kurmitola General Hospital'),
('fariha5500', '2023-02-06', 'Kurmitola General Hospital'),
('fatima84', '2022-09-12', 'Holy Family Hospital'),
('hero_alam', '2023-02-02', 'Combined Military Hospital'),
('imran786', '2022-12-08', 'Dhaka Medical College'),
('iqbal91', '2023-02-14', 'Popular Medical College and Hospital'),
('jaleel_s', '2023-03-14', 'Holy Family Hospital'),
('jamalhassan', '2022-10-27', 'Bangladesh Medical'),
('kabir6574', '2023-03-11', 'Labaid Hospital'),
('kamal1122', '2022-12-30', 'Kurmitola General Hospital'),
('kamal_r', '2022-11-03', 'Bangladesh Medical'),
('kamrul3322', '2023-07-18', 'Bangladesh Medical'),
('kamrul99', '2023-07-04', 'Ad-Din Medical'),
('karawita91', '2022-12-18', 'Evercare Hospital'),
('karim776', '2023-01-22', 'Mugda Medical College'),
('khaleel9900', '2023-04-15', 'Uttara Adhunik Medical'),
('khalid75', '2023-04-13', 'Shahabuddin Medical College'),
('maliha_215', '2023-05-25', 'Popular Medical College and Hospital'),
('nabila667', '2023-06-14', 'Square Hospital'),
('nadia44', '2022-12-23', 'Medinova Medical'),
('nafis_swag', '2023-06-14', 'Labaid Hospital'),
('naima777', '2023-04-18', 'Holy Family Hospital'),
('nasrin5500', '2023-01-25', 'Bangladesh Medical'),
('nasrin_26', '2023-01-03', 'Bangladesh Medical'),
('nazia333', '2022-10-22', 'Mugda Medical College'),
('nazmul881', '2022-10-23', 'Ad-Din Medical'),
('nishat5544', '2022-12-01', 'Mugda Medical College'),
('nusrat22', '2023-05-22', 'Medinova Medical'),
('rafiq22', '2022-10-10', 'Dhaka Medical College'),
('rahim7788', '2023-07-24', 'Bangladesh Medical'),
('rahima66', '2023-08-01', 'Shahabuddin Medical College'),
('rahman3344', '2023-05-03', 'Square Hospital'),
('raisa888', '2022-10-21', 'Uttara Adhunik Medical'),
('rashid555', '2022-09-04', 'Evercare Hospital'),
('rina66', '2023-08-07', 'Square Hospital'),
('sahar9', '2022-10-03', 'Popular Medical College and Hospital'),
('sahila8877', '2022-09-21', 'Dhaka Medical College'),
('saima5566', '2023-04-22', 'Combined Military Hospital'),
('saira5500', '2023-07-03', 'Bangabandhu Sheikh Mujib Medical University'),
('salim112', '2022-11-29', 'United Hospital'),
('samina909', '2023-06-21', 'Evercare Hospital'),
('shabnam7788', '2022-10-16', 'Holy Family Hospital'),
('shahid007', '2023-05-08', 'Evercare Hospital'),
('shahnaz442', '2023-02-27', 'Mugda Medical College'),
('yasir88', '2023-04-24', 'Medinova Medical');
