...
<body>
    <main class="flex flex-col space-y-6 justify-center items-center mt-9 mb-9">
        <h1 class="text-5xl text-center font-extrabold">
            <span class="text-[#295a8b]">Register</span> Here!
        </h1>
                ...
                <div class="space-y-5">
                    <form method="POST" autocomplete>
                        <div class="mb-4">
                            ...
                            <input name="name" class="w-[300px] bg-transparent border-b-2" id="name" type="text" required>
                        </div>

                        <div class="mb-4">
                            <label for="Uname"><strong>User Name:</strong></label><br>
                            <input name="user_name" class="w-[300px] bg-transparent border-b-2"
                            id="Uname" type="text" placeholder="Enter a unique username..." required autocomplete="off" autocomplete="new-password">
                        ...
                        <div class="mb-4"> 
                            ...
                            <input name="con" class="w-[300px] bg-transparent border-b-2" id="con" type="text" required>
                            <p style="color: red" class="text-danger"><?php if(isset($errors['c'])) echo $errors['c']; ?></p>
                        </div>

                        <div class="mb-4"> 
                            <label for="ag"><strong>Age:</strong></label><br>
                            <input name="age" class="w-[300px] bg-transparent border-b-2" id="ag" type="text" required>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input name="police_station" id="ps" class="w-[300px] bg-transparent border-b-2" type="text" required>
                        </div>

                        <div class="mb-4">
                            <label for="city"><strong>City:</strong></label><br>
                            <input name="city" id="city" class="w-[300px] bg-transparent border-b-2" type="text" required>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="password-container">
                                <input name="pass" class="bg-transparent border-b-2" type="password" id="pass" placeholder="Enter a strong password" required>
                        ...
                        <div class="mb-4">
                            ...
                            <input name="gender" id="Gender" class="bg-transparent border-b-2 w-[300px]" type="text" placeholder="Male/Female/Other" required>
                        </div>
